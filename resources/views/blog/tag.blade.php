...
@section('title', $tag->name . ' - ' . setting('site_name', config('app.name')))
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <nav class="mb-4">
                    <ol class="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <li>/</li>
                        <li class="text-gray-900">{{ $tag->name }}</li>
                    </ol>
                </nav>
                ...
                @if($tag->description)
                    <p class="text-lg text-gray-600 mb-2">{{ $tag->description }}</p>
                @endif
                <p class="text-sm text-gray-500">{{ $posts->total() }} articles</p>
            </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">No posts with this tag yet</h3>
